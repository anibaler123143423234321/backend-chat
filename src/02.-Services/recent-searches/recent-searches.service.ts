...
import { RecentSearch, SearchType } from 'src/02.-Services/recent-searches/entities/recent-search.entity';
import { CreateRecentSearchDto } from 'src/02.-Services/recent-searches/dto/create-recent-search.dto';
